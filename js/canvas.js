...
class CanvasBackground {
	...
	canvasSize() {
		this.canvas.width = this.canvas.offsetWidth * this.dpr;// * devicePixelRatio(this.dpr);
		this.canvas.height = this.canvas.offsetHeight * this.dpr;// * devicePixelRatio(this.dpr);
		this.ctx.scale(this.dpr, this.dpr);//(devicePixelRatio(this.dpr), devicePixelRatio(this.dpr));
	}
 ...
 let bubbleAnimate = new CanvasBackground("orb-canvas");
 bubbleAnimate.start();